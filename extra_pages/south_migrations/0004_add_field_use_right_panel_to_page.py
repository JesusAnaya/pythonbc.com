...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Page.use_right_panel'
        db.add_column(u'pages_page', u'use_right_panel',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Page.use_right_panel'
        db.delete_column(u'pages_page', u'use_right_panel')
